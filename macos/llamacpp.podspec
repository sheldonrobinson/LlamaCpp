...
Pod::Spec.new do |s|
  s.name             = 'llamacpp'
  s.version          = '0.0.1'
  s.summary          = 'llamacpp is a dart implementation of llama.cpp. It is a revision of mobile artificial intelligence distribution (maid)'
  s.description      = <<-DESC
llamacpp is a dart implementation of llama.cpp. It is a revision of mobile artificial intelligence distribution (maid)
                       DESC
  s.homepage         = 'https://github.com/sheldonrobinson/llamacpp'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'Sheldon Robinson' => 'sheldon.robinson@live.com' }
